        ...
        <header className="z-[999] relative">
            ...
            <nav className='flex fixed top-[0.15rem] left-1/2 h-12
                ...
                <ul className='flex w-[22rem] flex-wrap items-center justify-center
                    gap-y-1 text-[0.9rem] font-normal sm:w-[initial]
                    sm:flex-nowrap sm:gap-5 dark:text-[#dbd7fb] dark:text-opacity-75
                    dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-0'>
                    {links.map(link => (
                        <motion.li
                        ...
                        >
                            <Link
                                className={clsx('flex w-full items-center justify-center px-3 py-3 hover:text-gray-950 dark:hover:text-red-50 transition',
                                    {
                                        "text-gray-950 dark:text-red-50": activeSection === link.name,
                                    })}
                                href={link.hash}
                                onClick={() => {
                            ...
                            >
...

                                {
                                    link.name === activeSection && (
                                        <motion.span 
                                        className='bg-gradient-to-r from-[#fbe2e3]/50 to-[#dbd7fb]/50
